<?php
if (!isset($pageTitle))
    $pageTitle = "Direct Hire Monitoring";
    $pageScript = "directhiremonitoring";
if (!isset($pageScript))
    $pageScript = null;
?>
...
<body class="nk-body bg-white npc-default has-aside ">
                        ...
                        <div class="nk-content-inner">
                            ...
                            <div class="nk-content-body">
                                <div class="nk-content-wrap">
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Direct Hire Monitoring</h3>
                                                <div class="nk-block-des text-soft">
                                                    <p>Track direct hire quotes and artisan price negotiations</p>
                                                </div>
                                            </div>
                                            <div class="nk-block-head-content">
                                                        ...
                                                        <ul class="nk-block-tools g-3">
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="#" data-filter="all"><span>All Status</span></a></li>
                                                                            <li class="divider"></li>
                                                            ...
                                                            <li>
                                                                <button class="btn btn-primary" id="quoteSummaryBtn">
                                                                    <em class="icon ni ni-reports"></em><span>Summary</span>
                                                                </button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div id="activeFilters" style="display: none;" class="mb-3">
                                        <div class="alert alert-icon alert-primary alert-dismissible" role="alert" style="display: flex; align-items: center; padding: 12px 20px;">
                                            ...
                                            <div style="flex-grow: 1; min-width: 0;">
                                                ...
                                                <span id="activeFiltersText" style="margin-left: 8px;"></span>
                                            </div>
                                            <button type="button" class="btn-close" id="clearAllFilters" aria-label="Clear filters" style="margin-left: 16px;"></button>
                                        </div>
                                    </div>
                                    <div class="nk-block">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title" id="quoteSummaryModalLabel"><em class="icon ni ni-reports me-2"></em>Direct Hire Summary</h5>
    ...
    <div class="modal fade" id="advancedFilterModal" tabindex="-1" aria-labelledby="advancedFilterModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title" id="advancedFilterModalLabel"><em class="icon ni ni-filter me-2"></em>Advanced Filters</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="card card-bordered">
                        <div class="card-body">
                            <h6 class="card-title mb-3"><em class="icon ni ni-calendar-booking me-2"></em>Filter by Booking</h6>
                            <div class="mb-3">
                                <div class="form-control-wrap">
                                    <div class="form-icon form-icon-right">
                                        <em class="icon ni ni-search"></em>
                                    </div>
                                    <input type="text" class="form-control" id="booking-filter-search" placeholder="Search bookings by service, customer...">
                                </div>
                            </div>
                            <div id="bookingsFilterContent" style="max-height: 400px; overflow-y: auto;">
                                <div class="text-center py-5">
                                    <div class="spinner-border text-primary" role="status">
                                        <span class="visually-hidden">Loading...</span>
                                    </div>
    ...
    <div class="modal fade" id="bookingDetailsModal" tabindex="-1" aria-labelledby="bookingDetailsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title" id="bookingDetailsModalLabel"><em class="icon ni ni-calendar-booking me-2"></em>Booking Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
