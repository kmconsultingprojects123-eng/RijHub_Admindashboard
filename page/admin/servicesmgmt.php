                                                                ...
                                                                <div class="drodown"><a href="#"
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="#"><span>New Items</span></a>
                                                                            </li>
                                                                            <li><a href="#"><span>Featured</span></a>
                                                                            </li>
                                                                            <li><a href="#"><span>Out of
                                                                                        Stock</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="nk-block">
                                        <div class="row g-gs">
                                            ...
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="card card-bordered product-card">
                                                    <div class="product-thumb"><a href="product-details.html"><img
                                                                class="card-img-top" src="images/product/lg-h.jpg"
                                                                alt=""></a>
                                                        <ul class="product-actions">
                                                            <li><a href="#"><em class="icon ni ni-cart"></em></a></li>
                                                            <li><a href="#"><em class="icon ni ni-heart"></em></a></li>
                                                    ...
                                                    <div class="card-inner text-center">
                                                        ...
                                                        <h5 class="product-title"><a href="product-details.html">Modern
                                                                Smart watch</a></h5>
                                                        <div class="product-price text-primary h5"><small
                                                                class="text-muted del fs-13px">$200</small> $178</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="card card-bordered product-card">
                                                    <div class="product-thumb"><a href="product-details.html"><img
                                                                class="card-img-top" src="images/product/lg-g.jpg"
                                                                alt=""></a>
                                                        <ul class="product-badges">
                                                            <li><span class="badge bg-danger">Hot</span></li>
                                                        </ul>
                                                    ...
                                                    <div class="card-inner text-center">
                                                        ...
                                                        <h5 class="product-title"><a href="product-details.html">Gadget
                                                                Bundle</a></h5>
                                                        <div class="product-price text-primary h5"><small
                                                                class="text-muted del fs-13px">$609</small> $498</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="nk-add-product toggle-slide toggle-slide-right"
                                        ...
                                        <div class="nk-block">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="form-label"
                                                            for="sale-price">Sale Price</label>
                                                        <div class="form-control-wrap"><input type="number"
                                                                class="form-control" id="sale-price"></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="col-12">
                                                    <div class="upload-zone small bg-lighter my-2">
                                                        <div class="dz-message"><span class="dz-message-text">Drag and
                                                                drop file</span></div>
                                                    </div>
                                                </div>
                                                <div class="col-12"><button class="btn btn-primary"><em
...
<!-- Mirrored from dashlite.net/demo4/product-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Dec 2025 13:08:07 GMT -->
