...
if (!isset($pageTitle))
    $pageTitle = "Main Page";
    $pageScript = "services list";//load specific page script
if (!isset($pageScript))
    $pageScript = null;
?>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="card card-bordered h-100">
                                                    <div class="card-inner">
                                                        <div class="project">
                                                            <div class="project-head"><a href="apps-kanban.html"
                                                                    class="project-title">
                                                            ...
                                                            <div class="project-meta">
                                                                ...
                                                                </ul><span class="badge badge-dim bg-warning"><em
                                                ...
                                                <div class="card card-bordered h-100">
                                                    <div class="card-inner">
                                                        <div class="project">
                                                            ...
                                                            <div class="project-details">
                                                                <p>Design the website for Runnergy main website
                                                                    including their user dashboard.</p>
                                                            </div>
                                                            <div class="project-progress">
                                                                <div class="project-progress-details">
                                                                    <div class="project-progress-task"><em
                                                ...
                                                <div class="card card-bordered h-100">
                                                    <div class="card-inner">
                                                        <div class="project">
                                                            ...
                                                            <div class="project-details">
                                                                <p>Improve SEO keyword research, A/B testing, Local
                                                            ...
                                                            <div class="project-meta">
                                                                ...
                                                                </ul><span class="badge badge-dim bg-danger"><em
                                                ...
                                                <div class="card card-bordered h-100">
                                                    <div class="card-inner">
                                                        <div class="project">
                                                            ...
                                                            <div class="project-details">
                                                                <p>Develop the website using WordPree for the Fitness
                                                                    Next client.</p>
                                                            </div>
                                                            <div class="project-progress">
                                                                <div class="project-progress-details">
                                                    ...
                                                    <div class="card-inner">
                                                        <div class="project">
                                                            ...
                                                            <div class="project-meta">
                                                                ...
                                                                </ul><span class="badge badge-dim bg-success"><em
...
<!-- Mirrored from dashlite.net/demo4/project-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Dec 2025 13:07:57 GMT -->
